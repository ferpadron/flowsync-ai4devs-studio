...
| Fecha de vencimiento + vencidas (FS-118, HU-5+HU-8) | E2 | Sí | Medio | Media | 🟡 Intermedio | Aporta señal de retraso, pero no resuelve bloqueos ni es la métrica principal. La opcionalidad de la fecha está pendiente de PA-8 (abierto en el PRD); además hay propuestas todavía no aprobadas sobre si se permiten fechas pasadas y sobre la semántica del día exacto de vencimiento. |
