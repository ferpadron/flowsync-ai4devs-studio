...
| Fecha de vencimiento + vencidas (FS-118, HU-5+HU-8) | E2 | Sí | Medio | Media | 🟡 Intermedio | Aporta señal de retraso, pero no resuelve bloqueos ni es la métrica principal. La regla de "vencida" tiene varias ramas ambiguas ya cerradas en los criterios. |
