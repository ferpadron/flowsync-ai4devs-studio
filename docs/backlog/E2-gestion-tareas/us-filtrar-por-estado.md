...
5. DADO que el sistema me ha avisado de que el estado solicitado no es válido, CUANDO descarto ese aviso, ENTONCES la lista vuelve a mostrar el último filtro válido que tenía aplicado (o todas las tareas si no tenía ninguno), sin quedarse en blanco.
